...
import cn.porkchop.pinyougou.mapper.TbPayLogMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbPayLog;
import cn.porkchop.pinyougou.pojo.TbPayLogExample;
import cn.porkchop.pinyougou.sellergoods.service.PayLogService;
...
public class PayLogServiceImpl implements PayLogService {
	...
	public void delete(String[] ids) {
		...
		@Override
	public PageResult findWithConditionsByPagination(TbPayLog payLog, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
