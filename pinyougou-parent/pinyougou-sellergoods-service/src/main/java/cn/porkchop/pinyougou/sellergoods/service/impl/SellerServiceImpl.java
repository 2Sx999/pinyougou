...
import cn.porkchop.pinyougou.mapper.TbSellerMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbSeller;
import cn.porkchop.pinyougou.pojo.TbSellerExample;
...
public class SellerServiceImpl implements SellerService {
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbSeller seller, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
