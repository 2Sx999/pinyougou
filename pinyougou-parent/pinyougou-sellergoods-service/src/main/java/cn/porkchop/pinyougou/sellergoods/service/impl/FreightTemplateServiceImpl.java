...
import cn.porkchop.pinyougou.mapper.TbFreightTemplateMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbFreightTemplate;
import cn.porkchop.pinyougou.pojo.TbFreightTemplateExample;
import cn.porkchop.pinyougou.sellergoods.service.FreightTemplateService;
...
public class FreightTemplateServiceImpl implements FreightTemplateService {
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbFreightTemplate freightTemplate, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
