...
import cn.porkchop.pinyougou.mapper.TbGoodsDescMapper;
import cn.porkchop.pinyougou.mapper.TbGoodsMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbGoods;
import cn.porkchop.pinyougou.pojo.TbGoodsExample;
...
public class GoodsServiceImpl implements GoodsService {
    ...
    public void add(Goods goods) {
        ...
        goods.getGoodsDesc().setGoodsId(goods.getId());//设置ID
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbGoods goods, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
