...
import cn.porkchop.pinyougou.mapper.TbContentCategoryMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbContentCategory;
import cn.porkchop.pinyougou.pojo.TbContentCategoryExample;
import cn.porkchop.pinyougou.sellergoods.service.ContentCategoryService;
...
public class ContentCategoryServiceImpl implements ContentCategoryService {
	...
	public void delete(Long[] ids) {
		...
		@Override
	public PageResult findWithConditionsByPagination(TbContentCategory contentCategory, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
