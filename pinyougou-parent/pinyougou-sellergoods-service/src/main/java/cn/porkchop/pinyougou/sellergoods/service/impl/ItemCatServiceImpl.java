...
import cn.porkchop.pinyougou.mapper.TbItemCatMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbItemCat;
import cn.porkchop.pinyougou.pojo.TbItemCatExample;
import cn.porkchop.pinyougou.sellergoods.service.ItemCatService;
...
public class ItemCatServiceImpl implements ItemCatService {
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbItemCat itemCat, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
