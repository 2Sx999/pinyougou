...
import cn.porkchop.pinyougou.mapper.TbProvincesMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbProvinces;
import cn.porkchop.pinyougou.pojo.TbProvincesExample;
...
public class ProvincesServiceImpl implements ProvincesService {
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbProvinces provinces, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
