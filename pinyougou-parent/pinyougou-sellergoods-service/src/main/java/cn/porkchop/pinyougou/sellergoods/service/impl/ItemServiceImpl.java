...
import cn.porkchop.pinyougou.mapper.TbItemMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbItem;
import cn.porkchop.pinyougou.pojo.TbItemExample;
...
public class ItemServiceImpl implements ItemService {
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbItem item, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
