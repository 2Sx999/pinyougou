...
import cn.porkchop.pinyougou.mapper.TbAddressMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbAddress;
import cn.porkchop.pinyougou.pojo.TbAddressExample;
import cn.porkchop.pinyougou.sellergoods.service.AddressService;
...
public class AddressServiceImpl implements AddressService {
	...
	public void delete(Long[] ids) {
		...
		@Override
	public PageResult findWithConditionsByPagination(TbAddress address, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
