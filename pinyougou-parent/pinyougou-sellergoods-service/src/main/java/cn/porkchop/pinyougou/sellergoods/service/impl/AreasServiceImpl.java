...
import cn.porkchop.pinyougou.mapper.TbAreasMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbAreas;
import cn.porkchop.pinyougou.pojo.TbAreasExample;
...
public class AreasServiceImpl implements AreasService {
	...
	public void delete(Integer[] ids) {
		...
		@Override
	public PageResult findWithConditionsByPagination(TbAreas areas, int pageNum, int pageSize) {
		PageHelper.startPage(pageNum, pageSize);
