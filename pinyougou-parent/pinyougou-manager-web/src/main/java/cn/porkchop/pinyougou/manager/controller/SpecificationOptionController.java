...
public class SpecificationOptionController {
    ...
    public PageResult findByPagination(int page, int rows) {
        return specificationOptionService.findByPagination(page, rows);
    }
    ...
    public PageResult findWithConditionsByPagination(@RequestBody TbSpecificationOption specificationOption, int page, int rows) {
        return specificationOptionService.findWithConditionsByPagination(specificationOption, page, rows);
    }
