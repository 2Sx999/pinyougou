...
import cn.porkchop.pinyougou.sellergoods.service.ItemService;
...
public class ItemController {
	...
	public PageResult findByPagination(int page, int rows){
		return itemService.findByPagination(page, rows);
	}
	...
	public PageResult findWithConditionsByPagination(@RequestBody TbItem item, int page, int rows  ){
		return itemService.findWithConditionsByPagination(item, page, rows);
	}
