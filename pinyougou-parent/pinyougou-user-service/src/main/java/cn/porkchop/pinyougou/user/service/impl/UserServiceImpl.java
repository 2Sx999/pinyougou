package cn.porkchop.pinyougou.user.service.impl;

import cn.porkchop.pinyougou.mapper.TbUserMapper;
import cn.porkchop.pinyougou.pojo.PageResult;
import cn.porkchop.pinyougou.pojo.TbUser;
import cn.porkchop.pinyougou.pojo.TbUserExample;
...
public class UserServiceImpl implements UserService {
    ...
    @Override
    public PageResult findWithConditionsByPagination(TbUser user, int pageNum, int pageSize) {
        PageHelper.startPage(pageNum, pageSize);
